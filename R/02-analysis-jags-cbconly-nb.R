...
sink("/scratch/brolek/northwest-wrs/JAGSmodel_cbcnb.txt")
...
species <- c(1:11)[!1:11 %in% c(1,2,4,5,8)]
for (i in species){
  inits <- function(){
    list(
...
out <- jags(model.file="/scratch/brolek/northwest-wrs/JAGSmodel_cbcnb.txt", 
